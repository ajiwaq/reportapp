    ...
    render(){
      return(
        ...
        <ListItem selected>
          ...
          <Right>
            <Text style={styles.txtRight}>9</Text>
          </Right>
        </ListItem>
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>241 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
            <Text style={styles.txtLeft}>Daily Gain (g)</Text>

          </Left>
          <Right>
            <Text style={styles.txtRight}>33 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc9}</Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc9}</Text>
          </Right>
        </ListItem>
