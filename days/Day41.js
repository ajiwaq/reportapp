    ...
    render(){
      return(
        ...
        <ListItem selected>
          ...
          <Right>
            <Text style={styles.txtRight}>41</Text>
          </Right>
        </ListItem>
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>2548 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
        ...
        <ListItem>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc41} </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc41}</Text>
          </Right>
        </ListItem>
