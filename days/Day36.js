    ...
    render(){
      return(
        ...
        <ListItem selected>
          ...
          <Right>
            <Text style={styles.txtRight}>36</Text>
          </Right>
        </ListItem>
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>2102 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
        ...
        <ListItem>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc36}</Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc36}</Text>
          </Right>
        </ListItem>
