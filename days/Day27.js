      ...
      return(
        ...
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>1323 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>80 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc27} </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc27}</Text>
          </Right>
        </ListItem>
