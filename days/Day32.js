    ...
    render(){
      return(
        ...
        <ListItem selected>
          ...
          <Right>
            <Text style={styles.txtRight}>32</Text>
          </Right>
        </ListItem>
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>1748 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
        ...
        <ListItem>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc32} </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc32}</Text>
          </Right>
        </ListItem>
