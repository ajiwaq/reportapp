    ...
    render(){
      return(
        ...
        <ListItem selected>
          ...
          <Right>
            <Text style={styles.txtRight}>40</Text>
          </Right>
        </ListItem>
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>2459 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
        ...
        <ListItem>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc40} </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc40}</Text>
          </Right>
        </ListItem>
