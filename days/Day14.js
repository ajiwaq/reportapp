      ...
      return(
        ...
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>450 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>48 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc14} </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc14}</Text>
          </Right>
        </ListItem>
