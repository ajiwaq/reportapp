    ...
    render(){
      return(
        ...
        <ListItem selected>
          ...
          <Right>
            <Text style={styles.txtRight}>23</Text>
          </Right>
        </ListItem>
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>1011 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>73 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc23}</Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc23}</Text>
          </Right>
        </ListItem>
