    ...
    render(){
      return(
        ...
        <ListItem selected>
          ...
          <Right>
            <Text style={styles.txtRight}>11</Text>
          </Right>
        </ListItem>
        <ListItem>
         <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>135 </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
        ...
        <ListItem>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.dfc11} </Text>
          </Right>
        </ListItem>
        <ListItem>
          <Left>
          ...
          <Right>
            <Text style={styles.txtRight}>{this.props.cfc11}</Text>
          </Right>
        </ListItem>
