...
fetch('http://broilerhub.com/mobile_calculator/user_registration.php', {
  method: 'POST',
  headers: {
...
<View style={styles.MainContainer}>
        ...
        <Button title="Click Here To Register" onPress={this.UserRegistrationFunction.bind(this)} color="#2196F3" />
